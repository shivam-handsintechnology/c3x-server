...
Router.get("/activeServicetypes", ServiceTypeController.activeServiceType)
Router.get("/getServiceType", verify_token, ServiceTypeController.getServiceType)
Router.get("/GetAllBatchNumber", verify_token, AdminController.GetAllBatchNumber)
...
Router.post("/MultipleCreateAirwayBill", verify_token, ThirdPartyAPiController.MultipleCreateAirwayBill)
Router.post("/AirwayBillBatchPDFFormat", verify_token, ThirdPartyAPiController.AirwayBillBatchPDFFormat)
// End of CreateAirwayBill Routes
Router.post("/DueInvoices", verify_token, ThirdPartyAPiController.DueInvoices)
Router.post("/PaymentDues", verify_token, ThirdPartyAPiController.PaymentDues)
Router.post("/PrepaidAccountStatus", verify_token, ThirdPartyAPiController.PrepaidAccountStatus)
Router.post("/PrepaidPaymentHistory", verify_token, ThirdPartyAPiController.PrepaidPaymentHistory)
Router.post("/RateFinder", Credentials_Verify, ThirdPartyAPiController.RateFinder)
Router.post("/asaGuestSchedulePickup", Credentials_Verify, ThirdPartyAPiController.AsSchedulePickup)
Router.post("/SchedulePickup", verify_token, ThirdPartyAPiController.SchedulePickup)
...
Router.post("/DailyPickupDetailsForAccounts", verify_token, ThirdPartyAPiController.DailyPickupDetailsForAccounts)
